 ...
 * @param {number} limitAction The Limit Action of User
 * @param {Inventory[]} inventory The Inventory of User
 */
class Game {
    constructor(jid, xp, money, lastAction, inventory, limitAction) {
        /**
         * The JID of User
         * @type {string}
         */
    ...
    static addUser(jid) {
        ...
        return new Game(jid, 0, 0, LastAction.NEW_ACCOUNT, [], 50)
    }
